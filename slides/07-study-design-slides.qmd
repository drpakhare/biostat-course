...
## Can You Fill In This Design? {.smaller}
...
digraph cross_blank {
  ...
  node [fontname = 'Helvetica', shape = box, style = filled, fontsize = 11, margin = '0.15,0.08']
...
## Cross-Sectional: What Can You Measure? {.smaller}
...
digraph cc_blank {
  ...
  A [label = '?', fillcolor = '#B8D4E3']
  B [label = '?', fillcolor = '#E89595']
  C [label = '?', fillcolor = '#D4EAF7']
  D [label = '?', fillcolor = '#E8C07A']
  E [label = '?', fillcolor = '#A8D5A2']
  F [label = '?', fillcolor = '#E8C07A']
  G [label = '?', fillcolor = '#A8D5A2']
...
## Case-Control: What Can You Measure? {.smaller}
...
## Cohort: What Can You Measure? {.smaller}
...
## RCT: What Can You Measure? {.smaller}
...
## Identify the Design — Vignette 1 {.smaller}
...
## Identify the Design — Vignette 2 {.smaller}
...
## Identify the Design — Vignette 3 {.smaller}
...
## Identify the Design — Vignette 4 {.smaller}
